      ...
      <div class="bg-white rounded-lg border border-gray-200 p-6 text-center">
        @if (loading()) {
          <div class="py-8">
            ...
            <p class="text-sm text-gray-500">Accepting invite...</p>
          </div>
        } @else if (success()) {
          <div class="py-4">
            ...
            <p class="text-lg font-semibold text-gray-900 mb-2">Invite accepted!</p>
            <p class="text-sm text-gray-500 mb-4">You are now a member of the organization.</p>
            <a routerLink="/bots" class="text-sm text-indigo-600 hover:text-indigo-800 font-medium">Go to bots</a>
          </div>
        } @else {
          <div class="py-4">
            ...
            <p class="text-lg font-semibold text-gray-900 mb-2">Could not accept invite</p>
